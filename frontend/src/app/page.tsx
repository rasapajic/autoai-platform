...
const POPULAR_MAKES = [
  ...
  'Ford', 'Opel', 'Skoda', 'Renault', 'Peugeot',
  'Hyundai', 'Kia', 'Volvo', 'Seat', 'Mazda',
]
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      <style>{`
        ...
        .mkbtn:hover{border-color:var(--accent)!important;color:var(--accent)!important;background:rgba(255,107,0,.07)!important}
      `}</style>
      ...
      <div className="container" style={{ padding: '20px 16px 80px' }}>
        ...
        {/* AI Search */}
        <form onSubmit={handleAiSearch} style={{ marginBottom: 16 }}>
          <div style={{
            ...
            <button type="submit" disabled={aiLoading} style={{
              ...
              fontSize: 14, fontWeight: 700, cursor: aiLoading ? 'default' : 'pointer', whiteSpace: 'nowrap',
        ...
        <div style={{ marginBottom: 22 }}>
          <div style={{ fontSize: 11, color: 'var(--text3)', letterSpacing: '.08em', fontWeight: 600, marginBottom: 10 }}>
            BRZI IZBOR MARKE
          </div>
